...
Route::get('/pay_modes/{id}', [PayModeController::class, 'show'])->name('pay_modes.show');
Route::put('/pay_modes/{id}', [PayModeController::class, 'update'])->name('pay_modes.update');
Route::delete('/pay_modes/{id}', [PayModeController::class, 'destroy'])->name('pay_modes.destroy');
